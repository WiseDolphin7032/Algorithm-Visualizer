...
async function animateSwap(smallerIndex, largerIndex, boxes) {
    ...
    return new Promise(resolve => {
        ...
        smallerElement.style.transition = 'transform 0.5s ease';
        largerElement.style.transition = 'transform 0.5s ease';
...
async function showComparing(leftIndex, rightIndex, boxes) {
...
export default async function bubbleSort(array, length, container) {
    let temp;
